...
public class FrequentlyUsedFunctions1 {
	...
	public static void main(String[] args) {
      ...
      //Validate actitime search page opened or not
      String expectedTitle ="actitime";
      if(appTitle.equals(expectedTitle)) {
     System.out.println("actitime search page validate is passed"); 
	}else{
		System.out.println("actitime search page not opened or its title got changed");
